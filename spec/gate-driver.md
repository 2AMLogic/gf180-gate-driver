...
| Overvoltage / gate-oxide protection | **In scope, structural** | Addressed by the level-shifter topology choice itself (§4) rather than as a separate protection circuit — no thin-oxide node is designed to exceed 3.63 V. |
