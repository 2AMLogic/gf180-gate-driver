...
Ported from `2AMLogic/gf180-bandgap` (sim/harness/pdk.py), unchanged: PDK
resolution is single-supply-agnostic, so this repo's two-rail adaptation
(sim/harness/corners.py) does not need to touch it.
"""
